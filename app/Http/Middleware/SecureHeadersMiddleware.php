...
class SecureHeadersMiddleware
{
    ...
    public function handle($request, Closure $next)
    {
        ...
        // img-src unsafe-eval
        $response->headers->set('Content-Security-Policy', "img-src 'self' unpkg.com cdn.datatables.net https://googleads.g.doubleclick.net/pagead/id;");
        $response->headers->set('Content-Security-Policy', "img-src 'self' data: blob: unpkg.com cdn.datatables.net https://googleads.g.doubleclick.net/pagead/id;");
        $response->headers->set('Content-Security-Policy', "img-src 'self' data: blob: cdn.datatables.net https://googleads.g.doubleclick.net/pagead/id https://bappeda.kaltimprov.go.id;");
