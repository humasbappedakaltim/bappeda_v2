...
class SecureHeadersMiddleware
{
    ...
    public function handle($request, Closure $next)
    {
        ...
        $response->headers->set('Content-Security-Policy', "script-src 'self' 'unsafe-eval' unpkg.com cdn.datatables.net https://googleads.g.doubleclick.net/pagead/id;");
        $response->headers->set('Content-Security-Policy', "img-src 'self' data: blob: unpkg.com cdn.datatables.net https://googleads.g.doubleclick.net/pagead/id https://bappeda.kaltimprov.go.id;");
