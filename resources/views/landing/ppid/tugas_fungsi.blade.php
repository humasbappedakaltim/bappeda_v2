    ...
    <section class="breadcrumb-section position-relative d-flex justify-content-center m-0 p-0">
        <div class="container custom-container m-0 p-0">
            <div class="breadcrumb-container d-flex align-items-center gap-2 fs-8 mb-3">
                ...
                <p class="breadcrumb-active text-capitalize text-white fw-500 m-0 p-0">{{ translate('tugas dan fungsi ppid') }}</p>
            </div>
            <div class="title-content">
                <h4 class="title text-capitalize fw-bold mb-3">
                    {{ translate('tugas dan fungsi ppid bappeda') }}
                </h4>
                <p class="fs-8 text-white lh-sm">{{ translate('Tugas dan Fungsi PPID Bappeda Provinsi Kalimantan Timur') }}</p>
            </div>
        </div>
    </section>
    <!---------------------------------->
            ...
            <div class="row mx-0">
                <div class="col-12">
                    <div class="d-flex align-items-center justify-content-between mb-3">
                        <h5 class="title text-uppercase fw-bold fs-6">{{ translate('Tugas dan Fungsi PPID') }}</h5>
