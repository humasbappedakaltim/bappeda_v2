    ...
    <section class="breadcrumb-section position-relative d-flex justify-content-center m-0 p-0">
        <div class="container custom-container m-0 p-0">
            <div class="breadcrumb-container d-flex align-items-center gap-2 fs-8 mb-3">
                ...
                <p class="breadcrumb-active text-capitalize text-white fw-500 m-0 p-0">profil ppid bappeda</p>
            </div>
            <div class="title-content">
                <h4 class="title text-capitalize fw-bold mb-3">
                    profil ppid bappeda
                </h4>
                <p class="fs-8 text-white lh-sm">Profil PPID Bappeda Provinsi Kalimantan Timur</p>
            </div>
        </div>
    </section>
    <!---------------------------------->
                ...
                <hr class="hr-title-black flex-grow-1 ms-3">
                    ...
                    <ol>
                        <li class="text-justify fs-8 fw-light lh-sm">
                            menyusun dan melaksanakan kebijakan informasi dan menyusun laporan pelaksanaan kebijakan informasi dan dokumentasi;
                        </li>
                        <li class="text-justify fs-8 fw-light lh-sm">
                        ...
                        <li class="text-justify fs-8 fw-light lh-sm">
                            melakukan pembinaan, pengawasan, evaluasi dan monitoring atas pelaksanaan kebijakan informasi dan dokumentasi yang dilakukan PPID Pembantu;
                        </li>
                        <li class="text-justify fs-8 fw-light lh-sm">
                        ...
                        <li class="text-justify fs-8 fw-light lh-sm">
                            membentuk Tim Fasilitasi penanganan sengketa informasi yang ditetapkan dengan SK Gubernur.
                        </li>
                    </ol>
                    <p class="text-indent fs-8 lh-sm fw-light text-justify">
                        Tugas PPID :
                    ...
                    <ol>
                        ...
                        <li class="text-justify fs-8 fw-light lh-sm">
                            mengumpulkan, mengolah, dan mengompilasi bahan dan data lingkup komponen di lingkungan Pemerintahan Provinsi Kalimantan Timur menjadi bahan informasi publik;
                        </li>
                        <li class="text-justify fs-8 fw-light lh-sm">
                    ...
                    <ol>
                        <li class="text-justify fs-8 fw-light lh-sm">
                            PP 61 Tahun 2010 Tentang Pelaksanaan Undang-undang Nomor 14 tahun 2008 Tentang Keterbukaan Informasi Publik;
                        </li>
                        <li class="text-justify fs-8 fw-light lh-sm">
                    ...
                    <p class="fw-bold mb-3">
                        E. Aplikasi PPID Pemda pada Website Pemerintah Daerah
                    </p>
                    <p class="text-indent fs-8 lh-sm fw-light text-justify">
                    ...
                    <ol>
                        <li class="text-justify fs-8 fw-light lh-sm">
                            Ayat (2): Segala biaya yang diperlukan untuk pengelolaan pelayanan informasi dan dokumentasi di lingkungan Pemerintahan Provinsi dibebankan pada Anggaran Pendapatan dan Belanja Daerah Provinsi;
                        </li>
                        <li class="text-justify fs-8 fw-light lh-sm">
                            Ayat (3): Segala biaya yang diperlukan untuk pengelolaan pelayanan informasi dan dokumentasi di lingkungan Pemerintahan Kabupaten/Kota dibebankan pada Anggaran Pendapatan dan Belanja Daerah Kabupaten/Kota.
                        </li>
                    </ol>
                </div>
            </div>
