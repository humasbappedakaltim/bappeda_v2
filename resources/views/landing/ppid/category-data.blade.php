...
<section class="breadcrumb-section position-relative d-flex justify-content-center">
    <div class="container custom-container">
        <div class="breadcrumb-container d-flex align-items-center gap-2 fs-8 mb-3">
            <a href="{{ route('landing.index') }}" class="breadcrumb-link text-capitalize text-decoration-none fw-500 my-0 py-0 mx-0 px-0">beranda</a>
            ...
            <i class="bi bi-chevron-right text-white my-0 py-0 mx-0 px-0"></i>
            <p class="breadcrumb-active text-white fw-500 my-0 py-0 mx-0 px-0">Data Standar Pelayanan </p>
        </div>
...
<section class="over-top-section dc-detail-section position-relative d-flex justify-content-center my-0">
    <div class="container over-top-container m-0 p-0">
        <div class="title-content d-flex align-items-center justify-content-between mb-3">
            <p class="tagline text-uppercase fw-bold fs-4 py-0">Data Standar Pelayanan </p>
        ...
        <div class="row g-4 m-0 p-0 dc-document-list">
            ...
            <div class="col-12 col-md-6 col-lg-4 col-xl-3 mb-3">
                <div class="document-list-card position-relative text-decoration-none gap-2 p-3 pb-3">
                    ...
                    <p class="list-category text-grey text-start fs-8 lh-sm m-0 mb-2 p-0 w-100">{{ $data->category->name }}</p>
                    <p class="list-title text-start fs-8 lh-sm m-0 mb-3 p-0 w-100">{{ $data->name }}</p>
                    <div class="download-btn bappeda-primary-bg d-flex align-items-center float-end fs-7 m-0 mb-3 px-2 py-1 gap-2">
                        ...
                        <a href="{{ route('ppid.category.download', $data->slug) }}" download="{{ $data->file }}" target="__blank" class="text-white text-decoration-none fw-500 lh-sm">Unduh</a>
                    </div>
                </div>
            </div>
            @empty
            <div class="col-md-12 mb-3 text-center">
                <div class="document-list-card position-relative text-decoration-none gap-2 p-3 pb-3">
                    ...
                    <a href="{{ route('ppid.index') }}" class="btn btn-primary">Kembali</a>
                </div>
            </div>
            @endforelse
        </div>
