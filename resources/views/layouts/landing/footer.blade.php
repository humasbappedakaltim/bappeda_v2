<section class="footer-section position-relative d-flex justify-content-center px-0 py-5">
    <div class="container footer-container ">
        <div class="container border-bottomm d-flex align-items-center justify-content-center  py-3">
            <div class="row  w-100">
                            ...
                            <div class="d-flex align-items-start justify-content-start gap-2">
                                ...
                                <div class="d-flex flex-column align-items-start justify-content-start">
                                    ...
                                    <div class="d-flex align-items-start justify-content-start gap-2">
                                        ...
                                        <p class="content text-white">bappeda@kaltimprov.go.id</p>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <div class="container footerest  mt-5">
            <div class="row">
                <div class="col-xl-3 col-md-6">
                    <img src="{{ asset('assets/images/logo-bappeda.png')}}" class="logo-translate-y" alt="Logo Bappeda">
                </div>
