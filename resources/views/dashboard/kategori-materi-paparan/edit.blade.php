...
@section('title','Edit Kategori Data Center')
@section('content')
<h1 class="mb-3 h3">
    <strong>Edit Kategori Data Materi Paparan</strong>
</h1>
        ...
        <div class="w-100">
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-body">
                            <form action="{{ route('dashboard.category.materi_paparan.update', $category->slug) }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                <div class="mb-3 row">
                                    <div class="col-md-12">
