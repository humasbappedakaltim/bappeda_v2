...
@section('title','Tambah Data Paparan')
@push('css')
...
@section('content')
<h1 class="mb-3 h3">
    <strong>Tambah Data Paparan</strong>
</h1>
        ...
        <div class="w-100">
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-body">
                            <form action="{{ route('dashboard.data.materi_paparan.store') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="mb-3 row">
                                    <div class="col-md-12">
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="mt-2 col-md-12">
                                        ...
                                        <select name="status" id="status" class="form-control select2 @error('status') is-invalid @enderror">
                                            ...
                                            <option value="0" {{ old('status', 0) == '0' ? 'selected' : '' }}>Tidak Aktif</option>
                                        </select>
                                        @error('status')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
